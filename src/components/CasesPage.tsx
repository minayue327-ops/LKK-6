  ...
  return (
    <div className="bg-white min-h-screen text-neutral-800">
      ...
      <div className="relative bg-white border-b border-neutral-200/80 py-4 transition-all">
        <div className="max-w-[min(95%,1720px)] w-full mx-auto px-12 md:px-10 lg:px-24 2xl:px-12 space-y-4">
          ...
          <div className="space-y-3 pt-1 border-t border-neutral-100">
            ...
            <div className="flex items-start gap-3">
              <span className="text-xs font-bold text-neutral-400 shrink-0 w-12 pt-1.5">行业：</span>
              <div className="flex flex-wrap items-center gap-x-1.5 gap-y-2 py-0.5 flex-1">
                {INDUSTRIES.map((ind) => {
            ...
            <div className="flex items-start gap-3">
              <span className="text-xs font-bold text-neutral-400 shrink-0 w-12 pt-1.5">服务：</span>
              <div className="flex flex-wrap items-center gap-x-1.5 gap-y-2 py-0.5 flex-1">
                {SERVICES.map((srv) => {
            ...
            <div className="flex items-start gap-3">
              <span className="text-xs font-bold text-neutral-400 shrink-0 w-12 pt-1.5">客户：</span>
              <div className="flex flex-wrap items-center gap-x-1.5 gap-y-2 py-0.5 flex-1">
