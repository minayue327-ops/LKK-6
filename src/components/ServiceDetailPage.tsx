...
import { 
  ArrowRight, ShieldCheck, Sparkles, Zap, Award, Layers, 
  FileEdit, Monitor, PenTool, Box, LineChart, Network, Shapes, Code, 
  DoorOpen, LayoutList, Tag, BadgeCheck, Send, Wine, Package, ShoppingBag, 
  Store, Gem, Diamond 
} from 'lucide-react';
...
const SERVICE_DATA: Record<string, ServiceDetailConfig> = {
  'industrial-design': {
    ...
    capabilities: [
      { title: '产品定义', desc: '深度挖掘用户与市场核心诉求，清晰规划产品定位、功能架构与差异化竞争卖点。', icon: 'FileEdit' },
      { title: '设计研究', desc: '聚焦用户行为场景与人机交互痛点，以实证数据与敏锐洞察指导产品创新方向。', icon: 'Monitor' },
      { title: '外观设计', desc: '融合国际化前沿美学与品牌专属视觉符号，打造具备高辨识度与情感共鸣的产品形态。', icon: 'PenTool' },
      { title: '结构设计', desc: '严苛精算整机内部空间堆叠与创新机构，兼顾三防可靠性与规模化可制造性落地。', icon: 'Box' },
    ],
    process: [
      {
        step: '01',
  ...
  'structural-design': {
    ...
    capabilities: [
      { title: '仿真分析', desc: '运用高精CAE/FEA仿真测算与模流分析，规避结构风险与形变隐患。', icon: 'Shapes' },
      { title: '软硬件开发', desc: '深度协同嵌入式与机电系统开发，打通软硬件一体化运行逻辑。', icon: 'Code' },
      { title: '功能样机测试', desc: '全功能手板打样与极限工况实测，严密校核性能与人机手感。', icon: 'DoorOpen' },
      { title: '供应链管理', desc: '协同全球优质制造供应链，严格把控量产模具与交付质量。', icon: 'Network' },
    ],
    process: [
      {
        step: '01',
        title: '01-需求研发',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/banner1.jpg',
        keywords: ['技术需求拆解', '创新方案规划', '跨学科协同'],
      },
      {
        step: '02',
        title: '02-产品研发',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.35.png',
        keywords: ['功能技术研发', '外观结构设计', '原型方案打造'],
      },
      {
        step: '03',
        title: '03-验证优化',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/bannner2.png',
        keywords: ['样机测试验证', '技术迭代优化', '可行性评估'],
      },
      {
        step: '04',
        title: '04-供应链落地',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.39.png',
        keywords: ['供应链对接整合', '产品量产落地', '一站式交付'],
      },
    ],
    featuredCases: [
      {
  ...
  'full-case-design': {
    ...
    capabilities: [
      { title: '创新策略', desc: '洞察市场格局与受众深层诉求，明确品牌差异化战略与价值主张。', icon: 'LayoutList' },
      { title: '品牌标识', desc: '提炼品牌专属视觉基因与超级符号，打造强辨识度的独创Logo。', icon: 'Tag' },
      { title: 'VI体系', desc: '建立规范严谨的视觉识别体系，确保品牌资产全媒介标准一致。', icon: 'BadgeCheck' },
      { title: '品牌传播', desc: '赋能全场景营销与跨媒介传播物料，加速品牌商业价值破圈与落地。', icon: 'Send' },
    ],
    process: [
      {
        step: '01',
        title: '01-调研定位',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/banner1.jpg',
        keywords: ['市场洞察分析', '品牌核心提炼', '受众需求挖掘'],
      },
      {
        step: '02',
        title: '02-策略构建',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.35.png',
        keywords: ['视觉体系规划', '价值主张确立', '品牌理念塑造'],
      },
      {
        step: '03',
        title: '03-视觉设计',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/bannner2.png',
        keywords: ['LOGO设计', 'VI视觉落地', '品牌形象打造'],
      },
      {
        step: '04',
        title: '04-落地应用',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.39.png',
        keywords: ['物料设计输出', '传播适配优化', '全场景应用落地'],
      },
    ],
    featuredCases: [
      {
  ...
  'packaging-design': {
    ...
    capabilities: [
      { title: '瓶型瓶贴', desc: '定制人体工学瓶型与特色标签视觉，抢占货架黄金陈列位。', icon: 'Wine' },
      { title: '盒型包装', desc: '创新开箱仪式感与精巧盒型结构，提升拆箱互动与社交分享力。', icon: 'Package' },
      { title: '袋型包装', desc: '适配多元便携场景与环保柔性材质，兼顾防护性能与货架吸引力。', icon: 'ShoppingBag' },
      { title: '异形包装', desc: '突破常规结构的创意定制包材，打造自带流量的超级记忆点。', icon: 'Store' },
    ],
    process: [
      {
        step: '01',
  ...
  'ip-design': {
    ...
    capabilities: [
      { title: '文创策略规划', desc: '深度提炼文化内核与情绪价值，规划长线IP发展路径与商业场景。', icon: 'LayoutList' },
      { title: '文创品牌打造', desc: '赋予IP鲜明独特的人格与世界观，塑造具备高忠诚度的文创品牌。', icon: 'Gem' },
      { title: 'IP形象设计', desc: '绘制高辨识度角色形象与表情姿态，打磨极具亲和力的视觉载体。', icon: 'PenTool' },
      { title: '文创产品设计', desc: '联动潮玩、生活美学与衍生周边，实现文创IP的全产业链价值转化。', icon: 'FileEdit' },
    ],
    process: [
      {
        step: '01',
        title: '01-定位策划',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/banner1.jpg',
        keywords: ['文创内核提炼', '受众场景分析', 'IP形象定位'],
      },
      {
        step: '02',
        title: '02-创意创作',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.35.png',
        keywords: ['形象草图设计', '故事内容构建', '文创风格确立'],
      },
      {
        step: '03',
        title: '03-视觉深化',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/bannner2.png',
        keywords: ['形象视觉打磨', '延展体系设计', '体验场景打造'],
      },
      {
        step: '04',
        title: '04-落地开发',
        image: 'https://github.com/minaxyue-ops/MINA/releases/download/1/image.39.png',
        keywords: ['文创产品设计', '衍生开发落地', '场景化应用输出'],
      },
    ],
    featuredCases: [
      {
...
export default function ServiceDetailPage({
  ...
  const getCapabilityIcon = (iconName: string) => {
    switch (iconName) {
      case 'FileEdit': return <FileEdit className="w-7 h-7 text-[#007BC7]" />;
      case 'Monitor': return <Monitor className="w-7 h-7 text-[#007BC7]" />;
      case 'LineChart': return <LineChart className="w-7 h-7 text-[#007BC7]" />;
      case 'PenTool': return <PenTool className="w-7 h-7 text-[#007BC7]" />;
      case 'Box': return <Box className="w-7 h-7 text-[#007BC7]" />;
      case 'Network': return <Network className="w-7 h-7 text-[#007BC7]" />;
      case 'Shapes': return <Shapes className="w-7 h-7 text-[#007BC7]" />;
      case 'Code': return <Code className="w-7 h-7 text-[#007BC7]" />;
      case 'DoorOpen': return <DoorOpen className="w-7 h-7 text-[#007BC7]" />;
      case 'LayoutList': return <LayoutList className="w-7 h-7 text-[#007BC7]" />;
      case 'Tag': return <Tag className="w-7 h-7 text-[#007BC7]" />;
      case 'BadgeCheck': return <BadgeCheck className="w-7 h-7 text-[#007BC7]" />;
      case 'Send': return <Send className="w-7 h-7 text-[#007BC7]" />;
      case 'Wine': return <Wine className="w-7 h-7 text-[#007BC7]" />;
      case 'Package': return <Package className="w-7 h-7 text-[#007BC7]" />;
      case 'ShoppingBag': return <ShoppingBag className="w-7 h-7 text-[#007BC7]" />;
      case 'Store': return <Store className="w-7 h-7 text-[#007BC7]" />;
      case 'Gem': return <Gem className="w-7 h-7 text-[#007BC7]" />;
      case 'Diamond': return <Diamond className="w-7 h-7 text-[#007BC7]" />;
      case 'Sparkles': return <Sparkles className="w-7 h-7 text-[#007BC7]" />;
      case 'Zap': return <Zap className="w-7 h-7 text-[#007BC7]" />;
      case 'Layers': return <Layers className="w-7 h-7 text-[#007BC7]" />;
      case 'ShieldCheck': return <ShieldCheck className="w-7 h-7 text-[#007BC7]" />;
      case 'Award': return <Award className="w-7 h-7 text-[#007BC7]" />;
      default: return <Sparkles className="w-7 h-7 text-[#007BC7]" />;
    }
  };
  ...
  return (
    <div className="w-full bg-white text-[#1a1a1a] transition-colors">
      ...
      <section className="py-16 md:py-24 text-center bg-white relative overflow-hidden border-b border-neutral-100">
        <div className="max-w-4xl mx-auto px-[5%] relative z-10 flex flex-col items-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-[#8C8C8C] text-center font-mono mt-1">
              资深行业专家 1V1 深度对接
            </span>
          </div>
        ...
        <div className="max-w-[min(95%,1720px)] w-full mx-auto px-12 md:px-10 lg:px-24 2xl:px-12">
          <div className="achievement-grid">
            {data.metrics.map((m, idx) => {
              let numStr = m.value;
              let unitEl = null;
              if (m.value.includes('年')) {
                numStr = m.value.replace('年', '');
                unitEl = <span className="achievement-unit-gray">年</span>;
              } else if (m.value.includes('+')) {
                numStr = m.value.replace('+', '');
                const isBlue = numStr === '600' || numStr === '10000' || idx === 1 || idx === 3;
                unitEl = <span className={isBlue ? 'achievement-unit-blue' : 'achievement-unit-gray'}>+</span>;
              }
              return (
      ...
      <section className="py-16 md:py-20 bg-white border-b border-[#E5E5E5]">
        <div className="max-w-[min(95%,1720px)] mx-auto px-12 md:px-10 lg:px-24 2xl:px-12">
          <ScrollSectionTitle 
            badge="SERVICE CATEGORIES"
            title="服务分类"
            subtitle="覆盖从外观体验、结构工程到高精度的模具开发与柔性供应链全流程托管闭环。"
            align="between"
          />

          <div className={`grid gap-6 items-stretch ${data.capabilities.length === 6 ? 'grid-cols-2 sm:grid-cols-3 lg:grid-cols-6' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'}`}>
            {data.capabilities.map((cap, idx) => (
              <div key={idx} className="category-card group cursor-pointer flex flex-col items-center">
                ...
                {/* 标题文字：字号与下方流程板块标题完全一致 (text-lg md:text-xl font-bold) */}
                <h3 className="text-lg md:text-xl font-bold text-[#1A1A1A] font-display mb-2.5 whitespace-nowrap">
                  {cap.title}
                </h3>
                {/* 2行 line-clamp 描述 */}
      ...
      <section className="py-16 md:py-24 bg-white border-b border-[#E5E5E5] overflow-hidden">
        <div className="max-w-[min(95%,1720px)] mx-auto px-12 md:px-10 lg:px-24 2xl:px-12 relative">
          <ScrollSectionTitle 
            badge="SERVICE PROCESS"
            title="服务流程"
            subtitle="严谨的标准化创新交付闭环，从敏捷需求匹配、样机研发到规模化量产全程把控。"
            align="between"
          />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 items-stretch relative">
            {data.process.map((p, idx) => (
              <div key={idx} className="process-card relative flex flex-col h-full group rounded-[24px] overflow-hidden border border-[#E5E5E5] bg-white shadow-sm hover:border-[#007BC7]/40 hover:shadow-md transition-all duration-300">
                ...
                <div className="p-5 flex flex-col justify-between h-full relative z-10">
                  <div>
                    {/* 上方：4:3配图（苹果标准内嵌配图16px圆角，z-index: 2，盖在幽灵数字之上） */}
                    <div className="process-card-img-wrap aspect-[4/3] rounded-[16px] overflow-hidden relative mb-4 bg-neutral-100">
                      <img 
                        src={p.image} 
                        alt={p.title} 
                    ...
                    <div className="process-card-footer pt-1">
                      ...
                      <div className="flex flex-col gap-2 mt-2 min-h-[108px]">
                        {p.keywords.map((kw, kwIdx) => (
                          ...
                          >
                            ...
                            <span className="font-normal">{kw}</span>
                          </div>
                        ))}
                      </div>
                    </div>
      ...
      <section className="py-16 md:py-20 bg-white border-b border-[#E5E5E5]">
        <div className="max-w-[min(95%,1720px)] mx-auto px-12 md:px-10 lg:px-24 2xl:px-12">
          <ScrollSectionTitle 
            ...
            title="案例锦集"
            subtitle="甄选细分赛道代表性爆品案例，展现工业美学与研发落地的深度结合。"
            align="between"
          />
