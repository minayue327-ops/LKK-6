  ...
  return (
    <div className="w-full bg-white text-neutral-900 min-h-screen">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div>
              ...
              <h1 className="hero-title text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-[#111827] mt-2 leading-[1.05] font-display">
                <span className="text-[#111827]">成功路径</span>
                <span className="text-[#6B7280] font-light mx-2">·</span>
      ...
      <section id="success-path-faq" className="py-8 md:py-12 bg-white w-full border-b border-[#E5E5E5]">
        ...
        <div className="max-w-[min(95%,1720px)] w-full mx-auto px-12 md:px-10 lg:px-24 2xl:px-12 mb-8 py-3 px-4 bg-white border-b border-neutral-200/60 rounded-xl">
            ...
            {categories.map((cat) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className={`relative px-4 py-2 rounded-full text-sm md:text-base font-medium transition-all duration-200 cursor-pointer border-none bg-transparent flex items-center gap-2 shrink-0 select-none ${
                    isActive
                      ? 'text-[#007BC7] font-semibold'
                      : 'text-[#374151] hover:text-[#111827] hover:bg-neutral-100/70'
                  }`}
                >
                  {/* 活动状态的高亮背景衬底 */}
                  {isActive && (
                  ...
                  <span
                    className={`relative z-10 text-xs px-2 py-0.5 rounded-full font-mono transition-colors duration-200 ${
                      isActive
                        ...
                        : 'bg-neutral-100 text-[#6B7280] group-hover:bg-neutral-200'
                    }`}
                  >
                    {count}
                  </span>
        ...
        <div className="max-w-[min(95%,1720px)] w-full mx-auto px-12 md:px-10 lg:px-24 2xl:px-12">
          ...
          >
            {filteredFaqList.map((item, index) => (
              ...
              >
                {/* 问题标题（16px，字重600，#111827，hover 变 #007BC7，0.3s ease 过渡） */}
                <h4 className="text-base font-semibold text-[#111827] group-hover:text-[#007BC7] transition-colors duration-300 leading-snug flex items-center gap-2">
                ...
                {/* 回答内容（14px，#4B5563，行高1.6，默认直接展示） */}
                <p className="mt-2.5 text-sm text-[#4B5563] leading-relaxed pl-3.5">
                  {item.a}
                </p>
              </div>
            ))}
