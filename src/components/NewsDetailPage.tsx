    ...
    <div className="w-full bg-white text-neutral-900 min-h-screen">
        ...
        <div className="max-w-[min(95%,1720px)] w-full mx-auto px-12 md:px-10 lg:px-24 2xl:px-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div>
              ...
              <h1 className="hero-title text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-[#1A1A1A] leading-[1.05] font-display">
                {article.title}
              </h1>
              {/* 文章元数据信息 */}
      ...
      <main className="py-12 md:py-20 bg-white">
        <div className="max-w-[760px] w-full mx-auto px-4 md:px-0">
          ...
          {/* 主图展示 (苹果标准内嵌配图16px圆角，宽度撑满，说明文字13px #8C8C8C) */}
          {article.image && (
            <div className="my-8">
              <img 
                src={article.image} 
                ...
                className="w-full rounded-[16px] object-cover shadow-sm border border-neutral-100 max-h-[460px]"
              />
          ...
          {/* 正文富文本内容：段落16px, #333333或#4D4D4D, 行高1.8, 段落间距24px */}
