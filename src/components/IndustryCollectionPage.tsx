  ...
  return (
    <div className="w-full bg-white text-[#1a1a1a] transition-colors">
      ...
      <style>{`
        ...
        /* 辅助文字悬停交互：默认0fr折叠隐藏，hover平滑展开并淡入 */
        .industry-card-desc-wrap {
          display: grid;
          grid-template-rows: 0fr;
          transition: grid-template-rows 0.35s cubic-bezier(0.25, 1, 0.5, 1);
        }

        .industry-card:hover .industry-card-desc-wrap {
      ...
      <section id="category-hero" className="py-16 md:py-24 text-center bg-white relative overflow-hidden border-b border-neutral-100">
          ...
          <div className="achievement-grid">
            ...
            <div className="achievement-card">
              <div className="achievement-number">
                <ActiveCounter target={22} /><span className="achievement-unit-gray">年</span>
              </div>
            ...
            <div className="achievement-card">
              <div className="achievement-number">
                <ActiveCounter target={600} /><span className="achievement-unit-blue">+</span>
              </div>
            ...
            <div className="achievement-card">
              <div className="achievement-number">
                <ActiveCounter target={1000} /><span className="achievement-unit-gray">+</span>
              </div>
            ...
            <div className="achievement-card">
              <div className="achievement-number">
                <ActiveCounter target={10000} /><span className="achievement-unit-blue">+</span>
              </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="industry-card-text">
                    ...
                    <div className="industry-card-desc-wrap">
