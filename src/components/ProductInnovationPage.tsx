  ...
  return (
    <div className="w-full bg-white">
      ...
      <style>{`
        ...
        .section-text .scroll-section-header {
        ...
        .section-text .scroll-section-header span.font-mono {
          display: block !important;
          text-align: left !important;
          margin-bottom: 8px !important;
        }
        .section-text .scroll-section-header h2 {
          display: block !important;
          width: 100% !important;
        ...
        .section-text .scroll-section-header p {
          display: block !important;
          width: 100% !important;
          max-width: 100% !important;
          text-align: left !important;
        ...
        .section-text-link-secondary:hover {
          color: #007BC7 !important;
        }
      ...
      >
        <div className="max-w-4xl mx-auto px-[5%] relative z-10 flex flex-col items-center">
          ...
          >
            ...
            <span className="text-[#111827]">爆品打造</span>
          </motion.h1>
      ...
      {sections.map((sect) => {
        ...
        return (
          <React.Fragment key={sect.id}>
            ...
            <section 
              id={sect.id}
              className="section-showcase theme-light"
            >
              <div className="section-showcase-inner">
                ...
                <div className="section-text">
                  <ScrollSectionTitle 
                    badge={sect.englishTitle}
                    title={sect.title}
                    subtitle={sect.description}
                    align="left"
                    className="!mb-6 md:!mb-8 max-w-none"
                  />
